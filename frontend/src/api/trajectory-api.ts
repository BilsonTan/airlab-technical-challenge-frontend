...
export const fetchTrajectoriesApi = async (req?: IReq): Promise<TrajectoryTypes.Trajectory[]> => {
...
export const fetchAirportsApi = async (): Promise<TrajectoryTypes.Airports[]> => {
